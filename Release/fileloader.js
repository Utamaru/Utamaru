...
(function() {
    ...
    var REMOTE_PACKAGE_SIZE = 60979724;
    var PACKAGE_UUID = 'f72f1845-4173-4f60-a923-46af82e5ed41';
...
Module['FS_createPath']('/', 'Resources', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 85012, 0, 0).open('GET', '/mainData');
    new DataRequest(85012, 86888, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(86888, 96544, 0, 0).open('GET', '/resources.assets');
    new DataRequest(96544, 58905244, 0, 0).open('GET', '/sharedassets0.assets');
    new DataRequest(58905244, 60465616, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(60465616, 60979724, 0, 0).open('GET', '/Resources/unity_builtin_extra');
